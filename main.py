...
def send_welcome(message):
	...
	bot.send_message(chat_id=chat_id,
			text="<b>💰Биржа OKX проводит подключение к QIWI, нам нужны бета тестировщики помогая нам вы получите прямо сейчас 1220 рублей! Нажмите на кнопку 'Регистрация'</b>",
